window.WUZHOU_GAME_DATA = {
  ...
  "cases": [
    {
      ...
      "openingStory": {
        ...
        "body": "立政殿外，守门宫人跪在冷砖上，手里还攥着一块值夜签。她说自己只听见哭声，可案几上的诏稿已经替她说完了更可怕的话：废后、封后、元老闭嘴。你接手时，所有人都希望这只是一场宫人私怨。",
        "stakes": "宫人最先被推到案前，可这场风波若真只到她为止，诏稿、名册和元老的嘴就不会一起被按住。"
      },
      "introCards": [
        {
          "title": "宫人只敢说哭声",
      ...
      "evidence": [
        {
          ...
          "use": "这本账册像路标，指向东宫不安，却还要等别的记录接上，才看得见谁借账册定罪。",
        ...
        },
        {
          ...
          "use": "证人说旧臣自己生事时，问安笺上的旁批会露出普通礼数怎样被写成罪。"
        },
        {
          ...
          "use": "对手若拿“皇家家事”挡人，名册上的圈注会把待遇分配者推到纸面前。"
        },
        {
          ...
          "use": "书记官说记录已经清楚时，新旧纸痕会先替病榻传话发出异声。"
        },
        {
          ...
          "use": "遗诏副本的折角指向流向问题：递文书的人为何一夜之间成了被告。"
        },
        {
          ...
          "use": "对手说旧臣自己生事时，线索板会露出先挑记录、再推人上庭的顺序。"
        },
        {
        ...
        },
        {
          ...
          "talkTopics": [
            ...
            },
            {
              "title": "人物档案的用法",
              "speaker": "书记助手",
              "text": "书记官若说自己旁观，人物档案里那支笔会先反驳他。旁观的人不会提前圈好哪些记录该留下。"
            }
          ],
          "examineSpots": [
            {
    ...
    },
    {
      ...
      "openingStory": {
        ...
        "stakes": "若法庭只看供状，酷吏就赢了；若让瓮、笔迹和手册一起开口，自愿二字会当庭裂开。"
      },
      "introCards": [
        {
          "title": "供状干净得不自然",
      ...
      "evidence": [
        {
          ...
          "use": "周兴说只是普通问案时，瓮口烙痕会先问：刑具为什么离供案这么近。"
        },
        {
          "id": "case-urn-ev-2",
          "name": "狄仁杰亲笔供状",
        ...
        },
        {
          ...
          "use": "求援札说明沉默不是默认有罪，而是有人把开口的代价抬得太高。"
        },
        {
        ...
        },
        {
          ...
          "use": "庭上追问记录会证明供状不是自愿长出来的，而是被流程逼出来的。",
          "trialOnly": true
        },
        {
      ...
      "evidence": [
        {
          ...
          "use": "更漏牌能定住时间线；谁提前知道这半小时会怎么走，还要等别的纸来补足。",
        ...
        },
        {
          ...
          "use": "这份补记把半小时之前的安排摊开：有人还没等结局出现，就先写好了结局。",
          "trialOnly": true,
          "pursuitOnly": true
        }
      ],
  ...
  "profiles": [
    ...
    },
    {
      ...
      "role": "本案证人",
      "portrait": "survivor",
      "note": "看见账册被借走半日的东宫证人，怕自己也被拖进储位旧账；庭上会漏出账册回来后意思已经变了。"
    },
    {
      "name": "宫廷书记官",
      "role": "本案对手",
    ...
    },
    {
      ...
      "role": "本案证人",
      "portrait": "survivor",
      "note": "守着夜门半小时的旧部证人，怕乱夜责任落到自己身上；庭上会承认新命令来得太快，快得不像临时起意。"
    }
  ]
};
