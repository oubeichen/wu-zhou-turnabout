window.WUZHOU_GAME_DATA = {
  ...
  "cases": [
    {
      ...
      "openingStory": {
        ...
        "stakes": "若只听证词，最弱的人会背下罪名；若追纸张流向，后位真正怎样被挪开才会露出来。"
      },
      "introCards": [
        {
          "title": "宫人只敢说哭声",
          "body": "她不敢说出第一个喊“废后”的人。先找能替她开口的现场记录。"
        },
        {
          "title": "诏稿来得太早",
      ...
      "evidence": [
        ...
        },
        {
          ...
          "use": "证人只谈听来的哭声时，木签上的改痕会把当晚靠近摇篮的人重新带回现场。"
        },
        {
          ...
          "statements": [
            {
              ...
              "wrongEvidenceFeedback": "许敬宗正在挡住追问；他的说法背后，署名问题还没有浮出纸面。",
              "answerEvidence": null
            },
            {
    ...
    },
    {
      ...
      "openingStory": {
        ...
        "stakes": "别被混乱骗走视线。谁最早知道结局，谁就最早安排了结局。"
      },
      "introCards": [
        {
          "title": "半小时不该这么整齐",
  ...
  "profiles": [
    ...
    },
    {
      ...
      "role": "本案证人",
      "portrait": "survivor",
      "note": "夹在宫门哭声和废后诏稿之间的抄录人，最怕被问到谁先把“废后”塞进记录；一上庭就会露出哭声入案前已有口径。"
    },
    {
      "name": "许敬宗",
      "role": "本案对手",
      "portrait": "censor",
      "note": "替后位新说法压阵的对手，害怕诏稿、名册和元老抗议被放到同一条线上；庭上会暴露他如何把反对声写成旧臣怨言。"
    },
    {
      "name": "邠王守礼",
      "role": "本案证人",
    ...
    },
    {
      ...
      "role": "本案对手",
      "portrait": "censor",
      "note": "负责挑选和誊写东宫记录的人，最怕被证明自己不是旁观的笔；庭上会暴露他先圈好了哪些话该留下。"
    },
    {
      "name": "告密人",
      "role": "本案证人",
      "portrait": "censor",
      "note": "把纸投入铜匦的起点证人，只想把责任留在投入口；追问下会承认再见原札时，纸边已经多了官府标注。"
    },
    {
      "name": "魏元忠",
      "role": "本案证人",
      "portrait": "minister",
      "note": "见过供状和暗室痕迹的证人，怕签押已经堵死翻案入口；庭上会把空瓮声和过分干净的笔锋带回来。"
    },
    {
      "name": "周兴",
      "role": "本案对手",
      "portrait": "censor",
      "note": "熟悉逼供流程的酷吏对手，害怕那套旧法反咬自己；庭上越替流程辩护，越会露出审讯手册折角。"
    },
    {
      "name": "玄宗旧部",
      "role": "本案证人",
