...
- Current product shape: standalone static AVG-style website. The reader plays from Wu Zetian's first-person point of view, reads variable-length passages before each major choice, sees the current story paragraph refresh, and reaches a dedicated ending summary screen based on route tendencies.
