...
EVIDENCE_KITS = {
    "case-empress-seat": [
        {
            ...
            "detail": "纸面上先写的是宫中传闻，后半段却突然拐到废后和立后。像是有人等不及查清，先把结果按上去了。",
            "use": "废后这件事，不像一口闲气自己闹大的。",
        },
        {
            "name": "摇篮旁的值夜签",
            "type": "现场记录",
        ...
        },
        {
            ...
            "detail": "普通宫事不会把这些人一口气并到一册里。谁在场，谁被调开，往往比嘴上那句更诚实。",
            "use": "后位一动，卷进去的从来不止宫人。",
        },
        {
            "name": "元老联名折",
            ...
            "detail": "这份折子不是替谁喊冤，是朝臣明明白白地不肯让后位说改就改。折子压得越深，越说明有人心虚。",
            "use": "朝里不是没人出声，是有人偏要把这些声音按下去。",
        },
        {
            "name": "染墨的封后诏稿",
            "type": "诏书草稿",
            "summary": "诏稿上同时有删改和催办痕迹，说明结果早在庭上解释前就被推动。",
            "detail": "墨迹盖住了几个反对者的名字，新后的称号却留得清清楚楚。像是结果早在前头等着，只差补一套说辞。",
            "use": "有人巴不得后位一夜定死。",
        },
    ],
    "case-crown-shadow": [
        {
            ...
            "detail": "它只能看出东宫早就不太平，还扯不出是谁在背后改写账面。单靠这本账，还掀不翻桌子。",
            "use": "东宫的水，早就在账上浑了。",
        },
        {
            "name": "太子问安笺",
            ...
            "detail": "同一张纸，家里一句问安，转眼就能被写成试探储位。可怕的不是问安，是后头那支添字的笔。",
            "use": "有人拿一句问安，当成捅人的刀。",
        },
        {
            "name": "密封的皇子名册",
            ...
            "detail": "谁能见驾、谁被调离、谁只能干等，都被写在同一页。到了这一步，已经不是家里拌嘴了。",
            "use": "所谓家事，早被抄成了一张冷冰冰的座次表。",
        },
        {
            "name": "病榻旁的传位记录",
            "type": "宫廷记录",
            "summary": "高宗病中传话的记录前后不一致，有一段被换过纸。",
            "detail": "公开留下来的记录，也会被人换纸改句。真正靠不住的，未必是说话的人，可能正是这页纸。",
        ...
        },
        {
            ...
            "detail": "病势、储位、旧臣，全被翻到同一页上。旧臣不是自己站到案前的，是被人一页页找出来的。",
            "use": "旧臣不是自己撞上审判席的。",
        },
    ],
    "case-rebellion-box": [
        {
            ...
            "detail": "这只能说明确实有人投过书，还看不出后来是谁把案子越写越大。拿它直接定人死活，反倒正中别人下怀。",
            "use": "怀疑是从这儿起的，谋反却不是在这儿写死的。",
        },
        {
            "name": "讨武檄文残页",
            "type": "公开文告",
            ...
            "use": "残页少掉的那半截，比剩下这些狠话还要紧。",
        },
        {
            "name": "洛阳街口榜文",
            "type": "告示",
            "summary": "榜文把投书内容贴到街口，路人批注已经把传闻当成定罪。",
            "detail": "先有投书，再有榜文，最后满街的人都不敢替被告说一句话。怕劲不是自己长出来的，是被贴上墙的。",
            "use": "街上的怕，是被这张榜文贴出来的。",
        },
        {
            "name": "酷吏审讯名册",
            ...
            "detail": "告密人投的是纸，审讯的人改的是人。口供越整齐，越像有人在背后扶着笔。",
            "use": "该盯住的，不是投书人，是后头那只办案的手。",
        },
        {
            "name": "夜半加印的缉捕令",
            "type": "官府命令",
            "summary": "缉捕令在夜里加印，人数从一人变成一串旧臣。",
            "detail": "一张纸到了夜里，突然就能拖出一串名字。这不是顺势追查，倒像早有人备好了网。",
    ...
    "case-urn": [
        ...
        },
        {
            ...
            "detail": "供词看着齐整，手抖、停笔和补字却全留在纸上。甘心认罪的人，笔不该抖成这样。",
            "use": "这枚签押，怎么看都不像甘心认下。",
        },
        {
            "name": "御史台口供副本",
            ...
            "detail": "副本能让人看出供词不对劲，却还掀不到周兴最疼的地方。真要咬住他，还得把整套路数拖出来。",
            "use": "先裂开一道口子，后头还得继续往里掀。",
        },
        {
            "name": "周兴审讯手册",
            "type": "审讯手册",
            "summary": "手册把问话、恐吓和认罪步骤排成固定流程。",
            "detail": "问题不在某一句供词，而在有人把恐吓当成了办案手路。手册越旧，越说明这套东西用得熟。",
            "use": "这不是办案经验，是逼人认罪的老手路。",
        },
        {
            "name": "魏元忠求援札",
            "type": "私人札记",
    ...
    "case-half-hour-coup": [
        {
            ...
            "detail": "它只告诉人那半小时准得吓人，还没把结论是谁先写好的抖出来。现在亮出来，还差一点火候。",
        ...
        },
        {
            ...
            "detail": "奖赏留了下来，奖赏为什么来却被抽走。有人只想让法庭看见谁赢，不想让人看见谁早知道会赢。",
            "use": "谁在夜里捞到好处，簿子写得明明白白。",
        },
        {
            "name": "莫须有罪名纸条",
            "type": "罪名草稿",
...
def make_evidence(case: dict[str, object], lookup: dict[int, dict[str, object]]) -> list[dict[str, str]]:
    ...
    evidence.append(
        ...
        "use": board.get("use", "零碎纸页一旦并到一起，背后那只手就藏不住了。"),
        }
    )
    ...
    evidence.append(
        {
            ...
            "type": "庭审线索",
            "source": "由庭审追问整理",
            "summary": court_note.get("summary", "证人被逼到答不上来，这才在庭上漏出一道口子。"),
            "detail": court_note.get("detail", "它不是从现场捡来的，而是证人在庭上露了怯，书记顺手把那道空白写进了记录。"),
            "use": court_note.get("use", "原本各说各话的东西，到这儿终于撞到了一起。"),
            "trialOnly": True,
        }
    )
    ...
    evidence.append(
        {
            ...
            "use": pursuit_note.get("use", "证人越想绕开，问题越咬在这儿。"),
            "trialOnly": True,
            "pursuitOnly": True,
        }
    )
    ...
    return [
        {
            ...
            "description": site_script.get(
                "description",
                f"{case['location']}仍留着事发当天的痕迹。谁在场，谁躲开，得慢慢从现场里看。",
            ),
            "sceneVariant": "site",
            ...
            "legality": [
                {
                    ...
                    "press": str(case["branch"]["triggerPress"]),
                    "wrong": "张易之把所有异常都塞进“仓促”两个字里，可那口气分明太熟了。",
                },
                {
                    "text": str(case["branch"]["hiddenText"]),
                    "press": str(case["branch"]["hiddenPress"]),
                    "wrong": "张易之想把自己藏在乱局里，可那几笔好处偏偏都压在他名下。",
